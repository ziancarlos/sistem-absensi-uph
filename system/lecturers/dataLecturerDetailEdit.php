<?php
require_once("updateLecturerDetailEditFunction.php");
?>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control"
                                                    value="<?= isset($data["courseDetail"]) ? $data["courseDetail"]['Name'] : '' ?>" id="inputNamaMK"
                                                    name="name">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="inputKodeMK" class="col-sm-3 col-form-label">Kode Kelas</label>
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" id="inputKodeMK" name="kode"
                                                    value="<?= isset($data["courseDetail"]) ? $data["courseDetail"]['Code'] : '' ?>">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <select class="custom-select" name="ruang">
                                                    ...
                                                    <?php if ($classroom["ClassroomId"] == $data["courseDetail"]["ClassroomId"]): ?>
                                                    <option value="<?= $classroom["ClassroomId"] ?>" selected>
