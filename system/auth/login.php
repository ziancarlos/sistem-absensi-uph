...
<head>
    ...
    <title>Sistem Absensi UPH - Login</title>
                ...
                <div class="card-body p-0">
                    ...
                    <div class="row">
                        <div class="col-lg-5 d-none d-lg-block  bg-light">
                            <img src="../../assets/img/7EC1728B-D5B3-476D-8A63-8F4A8D803458_1_201_a-removebg-preview.png"
                                alt="" class="pt-5">
                        </div>
                                ...
                                <form class="user" method="post">
                                    ...
                                    <div class="form-group">
                                        <input type="email" class="form-control form-control-user" id="emailInput"
                                            placeholder="example@student.uph.edu" name="email">
                                    </div>
