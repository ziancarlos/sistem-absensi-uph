                    ...
                    <table id="example" class="display cell-border " style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?= ($attendance["Date"] == null) ? "-" : date("Y-m-d", strtotime($attendance["Date"])) ?>
                                </td>
                                ...
                                <td style="display: flex; gap: 5px;">
                                    <?php if ($role == "admin" || $role == "lecturer"): ?>
                                    <a href="updateAttendance.php?StudentId=<?= $attendance["StudentId"]; ?>&tanggal=<?= $attendance["Date"]; ?>&kodeMataKuliah=<?= $attendance["Code"]; ?>"
